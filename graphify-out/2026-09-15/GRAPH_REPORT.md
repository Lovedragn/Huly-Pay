# Graph Report - Huly.pay  (2026-09-15)

## Corpus Check
- 147 files · ~187,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1512 nodes · 2547 edges · 117 communities (66 shown, 43 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e16aa113`
...
## Communities (117 total, 43 thin omitted)
...
### Community 4 - "User"
Cohesion: 0.15
Nodes (10): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, User (+2 more)
...
Cohesion: 0.08
Nodes (24): appVersion, _avatarUrl, build, _buildAccountSection, _buildChartPaletteOptionCard, _buildGroupCard, _buildLogoutCard, _buildPreferencesSection (+16 more)
...
Cohesion: 0.13
Nodes (33): CategoryBreakdownResponse, DailySpendingResponse, MonthlySpendingResponse, SpendingSummaryResponse, CategoryRequest, CategoryResponse, CreateExpenseRequest, UpdateExpenseRequest (+25 more)
...
Cohesion: 0.05
Nodes (41): CustomPainter, DateTime?, build, cornerColor, cornerLength, cornerRadius, createState, dispose (+33 more)
...
Cohesion: 0.04
Nodes (47): DraggableScrollableNotification, GoogleMapController?, MapType, _accuracy, build, _buildActionButton, _buildDarkMapFallbackCanvas, _buildDetailRow (+39 more)
...
Cohesion: 0.08
Nodes (24): _authSubscription, _authTimeoutTimer, build, createState, didChangeAppLifecycleState, dispose, _finishSignIn, _handleBack (+16 more)
...
### Community 36 - "State"
Cohesion: 0.17
Nodes (16): AnalysisScreen, _AnalysisScreenState, HomeDashboardScreen, _HomeDashboardScreenState, SettingsScreen, _SettingsScreenState, SignInScreen, _SignInScreenState (+8 more)
...
Cohesion: 0.12
Nodes (20): DeleteMapping, GetMapping, PostMapping, PutMapping, ExpenseController, DeleteMapping, GetMapping, PostMapping (+12 more)

### Community 99 - "Expense"
Cohesion: 0.14
Nodes (14): Expense, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table (+6 more)
...
Cohesion: 0.06
Nodes (34): Map, amount, approvalRefNo, _channel, errorMessage, fromNativeMap, fromQueryString, googlePayPackage (+26 more)
...
Cohesion: 0.23
Nodes (11): AnalyticsController, CategoryController, RequestMapping, RestController, RequestMapping, RestController, UserController, UserService (+3 more)
...
Cohesion: 0.20
Nodes (10): LocalDatabaseService, UserPreferencesService, dbService, main, dbService, main, prefService, package:mobile/services/local_database_service.dart (+2 more)
...
### Community 123 - "org.springframework.transaction.annotation.Transactional"
Cohesion: 0.21
Nodes (7): CategoryService, BadRequestException, ResourceNotFoundException, ExpenseResponse, ExpenseService, org.springframework.transaction.annotation.Transactional, org.springframework.web.bind.annotation.ResponseStatus

### Community 124 - "package:flutter_test/flutter_test.dart"
Cohesion: 0.50
Nodes (3): main, package:flutter_test/flutter_test.dart, package:mobile/services/sms_filter_service.dart

## Knowledge Gaps
- **738 isolated node(s):** `com.hulypay:backend`, `INITIATED`, `PAYMENT_INITIATED`, `PENDING`, `CONFIRMED` (+733 more)
...
- **Why does `User` connect `User` to `org.springframework.http.ResponseEntity`, `Expense`, `org.junit.jupiter.api.Test`, `lombok.AllArgsConstructor`, `lombok.RequiredArgsConstructor`, `ExpenseRepository`, `org.springframework.transaction.annotation.Transactional`?**
