...
Cohesion: 0.08
Nodes (24): amount, _bottomTitleWidgets, build, _buildCardFooter, _buildCardHeader, _buildCurvedGradientData, _buildDualZoneData, _buildStyleTab (+16 more)
...
Cohesion: 0.06
Nodes (36): about_hulypay_screen.dart, help_support_screen.dart, MaterialPageRoute, _buildHeader, appVersion, _avatarUrl, build, _buildAccountSection (+28 more)
...
Cohesion: 0.06
Nodes (32): dart:io, Dio, Exception, int?, ApiException, createCategory, createExpense, createPayment (+24 more)
...
### Community 36 - "State"
Cohesion: 0.17
Nodes (17): AnalysisScreen, _AnalysisScreenState, HomeDashboardScreen, _HomeDashboardScreenState, NotificationsScreen, _NotificationsScreenState, SignInScreen, _SignInScreenState (+9 more)
...
Cohesion: 0.13
Nodes (15): build, _buildAmazonPayBrandIcon, _buildAppBar, _buildGPayBrandIcon, _buildPaymentAppCard, _buildPermissionsDisclosureCard, _buildSectionTitle, createState (+7 more)
...
Cohesion: 0.12
Nodes (15): IconData?, TransactionItem, PaymentModel, build, icon, label, onTap, svgAsset (+7 more)
...
Cohesion: 0.17
Nodes (12): List, AnalysisCategoryPieChart, _AnalysisCategoryPieChartState, build, centerLabel, createState, items, showCardBackground (+4 more)
...
Cohesion: 0.05
Nodes (38): Map, amazonPayPackage, amount, approvalRefNo, _channel, errorMessage, fromNativeMap, fromQueryString (+30 more)
...
Cohesion: 0.12
Nodes (15): HulyPayApp, AboutHulyPayScreen, AnimatedHulyLogo, AnimatedWaveBackground, QuickActionButton, build, _buildNavItem, CustomBottomNavBar (+7 more)
...
### Community 108 - "PaymentService.java"
Cohesion: 0.38
...
### Community 112 - "CategoryResponse"
Cohesion: 0.39
Nodes (3): PostMapping, PutMapping, CategoryResponse

### Community 114 - "package:flutter/foundation.dart"
Cohesion: 0.33
Nodes (5): main, package:flutter/foundation.dart, package:flutter/services.dart, package:mobile/services/google_pay_service.dart, package:mobile/services/upi_service.dart
...
Cohesion: 0.33
Nodes (5): main, package:mobile/models/category_model.dart, package:mobile/models/expense_model.dart, package:mobile/screens/scan_and_pay_screen.dart, package:mobile/services/location_service.dart
...
## Knowledge Gaps
- **837 isolated node(s):** `com.hulypay:backend`, `INITIATED`, `PAYMENT_INITIATED`, `PENDING`, `CONFIRMED` (+832 more)
...
- **Why does `User` connect `User` to `org.springframework.http.ResponseEntity`, `org.junit.jupiter.api.Test`, `PaymentService.java`, `lombok.AllArgsConstructor`, `ExpenseRepository`, `CategoryResponse`, `lombok.RequiredArgsConstructor`, `Expense`, `org.springframework.transaction.annotation.Transactional`?**
