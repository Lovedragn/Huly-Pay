...
## Corpus Check
- 149 files · ~186,579 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1431 nodes · 2302 edges · 110 communities (58 shown, 38 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1058cc69`
...
Cohesion: 0.04
Nodes (45): IconData?, amount, avatarUrl, category, CategorySpendingItem, changePercent, changePeriodLabel, color (+37 more)
...
Cohesion: 0.06
Nodes (32): CustomPainter, build, cornerColor, cornerLength, cornerRadius, createState, dispose, _handleBack (+24 more)
...
Cohesion: 0.05
Nodes (43): double get, TransactionItem, PaymentModel, _accuracy, build, _buildActionButton, _buildDarkMapFallbackCanvas, _buildDetailRow (+35 more)
...
Cohesion: 0.20
Nodes (8): ExpenseResponse, ExpenseController, DeleteMapping, GetMapping, PutMapping, RequestMapping, RestController, org.springframework.transaction.annotation.Transactional
...
Cohesion: 0.09
Nodes (21): Animation, AnimationController, Duration, home_dashboard_screen.dart, build, _checkLocalStorage, _controller, createState (+13 more)
...
Cohesion: 0.16
Nodes (12): AnalyticsController, PostMapping, GetMapping, GetMapping, PutMapping, RequestMapping, RestController, UserController (+4 more)
...
Cohesion: 0.23
Nodes (14): AnalyticsService, CategoryService, ExpenseRepository, ExpenseService, RequestMapping, RestController, PaymentController, PaymentService (+6 more)
...
### Community 99 - "CategoryResponse"
Cohesion: 0.22
Nodes (7): CategoryController, GetMapping, PostMapping, PutMapping, RequestMapping, RestController, CategoryResponse

### Community 101 - "PaymentResponse"
Cohesion: 0.17
Nodes (7): DeleteMapping, BadRequestException, ResourceNotFoundException, PaymentResponse, PostMapping, PutMapping, org.springframework.web.bind.annotation.ResponseStatus
...
## Knowledge Gaps
- **690 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+685 more)
...
- **Why does `User` connect `User` to `lombok.RequiredArgsConstructor`, `Category`, `CategoryResponse`, `org.springframework.data.jpa.repository.Query`, `PaymentResponse`, `org.springframework.transaction.annotation.Transactional`, `lombok.AllArgsConstructor`, `org.springframework.http.ResponseEntity`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `PaymentModel` connect `single_transaction_screen.dart` to `payment_model.dart`, `dashboard_data.dart`?**
