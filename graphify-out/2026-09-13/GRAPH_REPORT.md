...
## Corpus Check
- 136 files · ~175,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1210 nodes · 1989 edges · 98 communities (48 shown, 37 thin omitted)
...
### Community 1 - "Expense"
Cohesion: 0.08
Nodes (22): Expense, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table (+14 more)
...
Cohesion: 0.05
Nodes (31): Any, app_links, Cocoa, Flutter, FlutterAppDelegate, FlutterImplicitEngineBridge, FlutterImplicitEngineDelegate, FlutterMacOS (+23 more)

### Community 6 - "PaymentStatus"
Cohesion: 0.17
...
Cohesion: 0.09
Nodes (21): analysis_screen.dart, DashboardData, build, _buildBody, _buildDashboardContent, _buildHeader, _buildQuickActions, _buildRecentTransactionsSection (+13 more)

### Community 9 - "settings_screen.dart"
Cohesion: 0.08
Nodes (23): appVersion, build, _buildAccountSection, _buildGroupCard, _buildLogoutCard, _buildPreferencesSection, _buildProfileCard, _buildSettingRow (+15 more)

### Community 10 - "transactions_screen.dart"
Cohesion: 0.10
Nodes (20): dart:io, _allGroups, build, _buildFilterChips, _buildGroupedTransactions, _buildHeader, _buildSearchBar, createState (+12 more)
...
Cohesion: 0.12
Nodes (18): List, HulyPayApp, QuickActionButton, CustomBottomNavBar, build, centerLabel, DonutChart, items (+10 more)
...
Cohesion: 0.12
Nodes (19): main, main, main, main, package:flutter/material.dart, package:flutter_test/flutter_test.dart, package:mobile/models/category_model.dart, package:mobile/models/dashboard_data.dart (+11 more)
...
Cohesion: 0.05
Nodes (39): api_client.dart, auth_service.dart, Dio, Exception, int?, ApiClient, ApiException, createCategory (+31 more)
...
Cohesion: 0.11
Nodes (18): Color, build, createState, _finishSignIn, _handleBack, _handleGitHubSignIn, _handleGoogleSignIn, _isLoadingGitHub (+10 more)
...
Cohesion: 0.11
Nodes (17): appFontFallback, appFontFamily, build, home, initialize, main, showSplash, supabaseAnonKey (+9 more)
...
### Community 36 - "State"
Cohesion: 0.18
Nodes (15): AnalysisScreen, _AnalysisScreenState, HomeDashboardScreen, _HomeDashboardScreenState, SettingsScreen, _SettingsScreenState, SingleTransactionScreen, _SingleTransactionScreenState (+7 more)

### Community 37 - "splash_screen.dart"
Cohesion: 0.11
Nodes (18): Animation, AnimationController, dart:async, Duration, home_dashboard_screen.dart, build, _controller, createState (+10 more)
...
Cohesion: 0.29
Nodes (6): analysisCategoryItems, dashboardData, MockData, transactionScreenGroups, static const DashboardData, static const List
...
- **Why does `User` connect `User` to `Expense`, `Category`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Category` connect `Category` to `User`, `Expense`?**
