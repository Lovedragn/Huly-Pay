...
## Corpus Check
- 126 files · ~167,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 991 nodes · 1709 edges · 95 communities (44 shown, 38 thin omitted)
...
4. `Expense` - 19 edges
5. `Payment` - 18 edges
6. `ExpenseResponse` - 17 edges
7. `UserService` - 17 edges
8. `CategoryResponse` - 16 edges
9. `ErrorResponse` - 16 edges
10. `CategoryRepository` - 15 edges
...
### Community 1 - "ExpenseRepository"
Cohesion: 0.18
Nodes (7): AnalyticsService, ExpenseRepository, PaymentRepository, UserRepository, org.springframework.data.jpa.repository.JpaRepository, org.springframework.data.jpa.repository.Query, org.springframework.stereotype.Repository
...
Cohesion: 0.07
Nodes (27): amount, avatarUrl, category, CategorySpendingItem, changePercent, changePeriodLabel, color, day (+19 more)
...
Cohesion: 0.06
Nodes (29): Any, app_links, Cocoa, Flutter, FlutterAppDelegate, FlutterImplicitEngineBridge, FlutterImplicitEngineDelegate, FlutterMacOS (+21 more)

### Community 6 - "lombok.AllArgsConstructor"
Cohesion: 0.25
Nodes (18): CategoryBreakdownResponse, DailySpendingResponse, MonthlySpendingResponse, SpendingSummaryResponse, CategoryRequest, CategoryResponse, CreateExpenseRequest, ExpenseResponse (+10 more)
...
Cohesion: 0.10
Nodes (19): analysis_screen.dart, DashboardData, build, _buildBody, _buildDashboardContent, _buildHeader, _buildQuickActions, _buildRecentTransactionsSection (+11 more)

### Community 9 - "settings_screen.dart"
Cohesion: 0.10
Nodes (19): appVersion, build, _buildAccountSection, _buildGroupCard, _buildLogoutCard, _buildPreferencesSection, _buildProfileCard, _buildSettingRow (+11 more)

### Community 10 - "transactions_screen.dart"
Cohesion: 0.10
Nodes (19): _allGroups, build, _buildFilterChips, _buildGroupedTransactions, _buildHeader, _buildSearchBar, createState, dispose (+11 more)
...
Cohesion: 0.11
Nodes (17): ../data/mock_data.dart, build, _buildCategoryList, _buildHeader, _categories, createState, initialCategories, initState (+9 more)
...
Cohesion: 0.11
Nodes (18): Color, CustomPainter, build, cornerColor, cornerLength, cornerRadius, createState, _handleBack (+10 more)
...
Cohesion: 0.13
Nodes (14): build, _buildActionButton, _buildDetailRow, _buildDetailsCard, _buildHeroReceiptCard, _buildQuickActionButtons, _buildSectionHeader, _buildShopBanner (+6 more)

### Community 21 - "widget_test.dart"
Cohesion: 0.11
Nodes (17): main, main, package:flutter_test/flutter_test.dart, package:mobile/main.dart, package:mobile/models/user_profile.dart, package:mobile/screens/analysis_screen.dart, package:mobile/screens/home_dashboard_screen.dart, package:mobile/screens/scan_and_pay_screen.dart (+9 more)
...
Cohesion: 0.21
Nodes (5): BadRequestException, ResourceNotFoundException, ExpenseService, org.springframework.transaction.annotation.Transactional, org.springframework.web.bind.annotation.ResponseStatus

### Community 24 - "api_client.dart"
Cohesion: 0.04
Nodes (45): api_client.dart, auth_service.dart, dart:io, Dio, Exception, int?, appFontFallback, appFontFamily (+37 more)
...
Cohesion: 0.12
Nodes (16): home_dashboard_screen.dart, build, createState, _finishSignIn, _handleBack, _handleGitHubSignIn, _handleGoogleSignIn, _isLoadingGitHub (+8 more)
...
Cohesion: 0.12
Nodes (15): HulyPayApp, SingleTransactionScreen, QuickActionButton, build, _buildNavItem, CustomBottomNavBar, isQrActive, onItemSelected (+7 more)

### Community 33 - "Payment"
Cohesion: 0.14
Nodes (8): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, Payment

### Community 34 - "transaction_tile.dart"
Cohesion: 0.18
Nodes (10): MaterialPageRoute, TransactionItem, _openScanAndPay, _openScanAndPay, _openScanAndPay, build, onTap, transaction (+2 more)
...
### Community 36 - "State"
Cohesion: 0.23
Nodes (12): AnalysisScreen, _AnalysisScreenState, HomeDashboardScreen, _HomeDashboardScreenState, SettingsScreen, _SettingsScreenState, SignInScreen, _SignInScreenState (+4 more)

### Community 37 - "User"
Cohesion: 0.20
Nodes (8): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, User

### Community 38 - "CategoryService"
Cohesion: 0.36
Nodes (5): CategoryService, PaymentService, jakarta.annotation.PostConstruct, lombok.extern.slf4j.Slf4j, org.springframework.stereotype.Service
...
### Community 90 - "Expense"
Cohesion: 0.20
Nodes (8): Expense, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table

### Community 91 - "PaymentStatus"
Cohesion: 0.25
Nodes (7): PaymentStatus, CANCELLED, FAILED, INITIATED, PENDING, SUCCESS, UNKNOWN
...
- **Why does `User` connect `User` to `org.springframework.http.ResponseEntity`, `ExpenseRepository`, `Category`, `Payment`, `lombok.AllArgsConstructor`, `CategoryService`, `org.springframework.transaction.annotation.Transactional`, `Expense`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Category` connect `Category` to `User`, `lombok.AllArgsConstructor`, `CategoryService`, `org.springframework.transaction.annotation.Transactional`, `Expense`?**
